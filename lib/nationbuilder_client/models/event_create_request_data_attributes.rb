...
module NationbuilderClient
  class EventCreateRequestDataAttributes
    ...
    #         Attribute used to write data to the given event's Venue address.         When an address already exists, provided values will be used to patch the existing address data,         only overwriting values provided in the payload.         When no address exists, the existing data will be used to persist a new address. 
    attr_accessor :venue_address_attributes
    ...
    def self.attribute_map
      {
        ...
        :'venue_address_attributes' => :'venue_address_attributes'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'venue_name' => :'String',
        :'venue_address_attributes' => :'Object'
      }
    end
    ...
    def self.openapi_all_of
      [
      :'EventReadWriteAttributes',
      :'EventWriteOnlyAttributes'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NationbuilderClient::EventCreateRequestDataAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NationbuilderClient::EventCreateRequestDataAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'venue_address_attributes')
        self.venue_address_attributes = attributes[:'venue_address_attributes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          venue_address_attributes == o.venue_address_attributes
    end
