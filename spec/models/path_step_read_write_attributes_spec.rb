...
# Unit tests for NationbuilderClient::PathStepReadWriteAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NationbuilderClient::PathStepReadWriteAttributes do
  let(:instance) { NationbuilderClient::PathStepReadWriteAttributes.new }

  describe 'test an instance of PathStepReadWriteAttributes' do
    it 'should create an instance of PathStepReadWriteAttributes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NationbuilderClient::PathStepReadWriteAttributes)
    end
  end
