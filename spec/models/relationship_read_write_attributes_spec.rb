...
# Unit tests for NationbuilderClient::RelationshipReadWriteAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NationbuilderClient::RelationshipReadWriteAttributes do
  let(:instance) { NationbuilderClient::RelationshipReadWriteAttributes.new }

  describe 'test an instance of RelationshipReadWriteAttributes' do
    it 'should create an instance of RelationshipReadWriteAttributes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NationbuilderClient::RelationshipReadWriteAttributes)
    end
  end
