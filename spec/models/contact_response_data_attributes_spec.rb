...
# Unit tests for NationbuilderClient::ContactResponseDataAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NationbuilderClient::ContactResponseDataAttributes do
  let(:instance) { NationbuilderClient::ContactResponseDataAttributes.new }

  describe 'test an instance of ContactResponseDataAttributes' do
    it 'should create an instance of ContactResponseDataAttributes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NationbuilderClient::ContactResponseDataAttributes)
    end
  end
