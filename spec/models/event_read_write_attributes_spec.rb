...
# Unit tests for NationbuilderClient::EventReadWriteAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NationbuilderClient::EventReadWriteAttributes do
  let(:instance) { NationbuilderClient::EventReadWriteAttributes.new }

  describe 'test an instance of EventReadWriteAttributes' do
    it 'should create an instance of EventReadWriteAttributes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NationbuilderClient::EventReadWriteAttributes)
    end
  end
