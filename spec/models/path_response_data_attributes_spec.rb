...
# Unit tests for NationbuilderClient::PathResponseDataAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NationbuilderClient::PathResponseDataAttributes do
  let(:instance) { NationbuilderClient::PathResponseDataAttributes.new }

  describe 'test an instance of PathResponseDataAttributes' do
    it 'should create an instance of PathResponseDataAttributes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NationbuilderClient::PathResponseDataAttributes)
    end
  end
