...
# Unit tests for NationbuilderClient::SignupTagsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SignupTagsApi' do
  before do
  ...
  describe 'test an instance of SignupTagsApi' do
    it 'should create an instance of SignupTagsApi' do
      expect(@api_instance).to be_instance_of(NationbuilderClient::SignupTagsApi)
    end
  end

  # unit tests for create_signup_tag
  # Create a signup tag
  ...
  describe 'create_signup_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_signup_tag
  ...
  describe 'delete_signup_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_signup_tags
  ...
  describe 'list_signup_tags test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for show_signup_tag
  ...
  # @option opts [String] :fields_signup_tags Comma-delimited list of attributes to only return in the response
  # @return [SignupTagShowResponse]
  describe 'show_signup_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_signup_tag
  ...
  # @return [SignupTagShowResponse]
  describe 'update_signup_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
